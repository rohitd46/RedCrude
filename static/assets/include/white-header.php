            ...
            <div class="container">
                ...
                <div class="dummy-hide">
                    <div class="collapse navbar-collapse" id="collapsibleNavId">
                        <ul class="navbar-nav ms-auto mt-2 mt-lg-0 whiteheader-menus">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-items" aria-labelledby="dropdownId">
                                    <ul>
                                        ...
                                        <li> <a class="dropdown-item" href="terms-conditions.php">Terms & Conditions</a>
                                        </li>
                                        <li> <a class="dropdown-item" href="privacy-policy.php">Privacy Policy</a></li>
                                        <li> <a class="dropdown-item" href="freatue-business.php">FEATURES FOR
                                                BUSINESS</a></li>
                                    </ul>
                        ...
                        <div class="d-none d-md-block ms-auto">
                            <ul class="navbar-nav mt-2 mt-lg-0 gap-2">
                                <li class="nav-item dropdown position-relative">
                                    <a class="nav-link caret-none" href="javascript:void(0);" id="navbarDropdown" role="button">
